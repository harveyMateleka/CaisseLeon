...
Invoice.prototype = {
     ...
     */
    newRow: function () {
        jQuery(".item-row:last").after('<tr class="item-row"><td class="item-name"><div class="delete-btn"><input type="text" required class="form-control item text-uppercase" placeholder="Ecrivez le nom de l\'article" type="text"><a tabindex="-3" class=' + $.opt.delete.substring(1) + ' href="javascript:;" title="Supprimer la ligne">X</a></div></td><td><input required class="form-control qty" placeholder="Qte"  value="1" type="text"></td><td><input required class="form-control price" placeholder="Prix" type="text"> </td><td><span class="total">0.00</span></td></tr>');
